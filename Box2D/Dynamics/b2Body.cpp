...
b2Body::b2Body(const b2BodyDef* bd, b2World* world)
{
	...
	b2Assert(b2IsValid(bd->angularDamping) && bd->angularDamping >= 0_fx);
	b2Assert(b2IsValid(bd->linearDamping) && bd->linearDamping >= 0_fx);
...
void b2Body::ResetMassData()
{
	...
	if (m_I > 0_fx && (m_flags & e_fixedRotationFlag) == 0)
	{
...
void b2Body::SetMassData(const b2MassData* massData)
{
	...
	if (massData->I > 0_fx && (m_flags & b2Body::e_fixedRotationFlag) == 0)
	{
