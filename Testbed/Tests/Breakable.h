...
public:
	...
	Breakable()
	{
		...
		// Breakable dynamic body
		{
			...
			bd.position.Set(0_fx, 40_fx);
			bd.angle = "0.25"_fx * b2_pi;
			m_body1 = m_world->CreateBody(&bd);

			m_shape1.SetAsBox("0.5"_fx, "0.5"_fx, b2Vec2(-"0.5"_fx, 0_fx), 0_fx);
			m_piece1 = m_body1->CreateFixture(&m_shape1, 1_fx);

			m_shape2.SetAsBox("0.5"_fx, "0.5"_fx, b2Vec2("0.5"_fx, 0_fx), 0_fx);
			m_piece2 = m_body1->CreateFixture(&m_shape2, 1_fx);
		}
	...
	void Break()
	{
		...
		m_piece2 = body2->CreateFixture(&m_shape2, 1_fx);
