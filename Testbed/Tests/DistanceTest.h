...
public:
	...
	{
		{
			...
			m_transformA.p.Set(0_fx, -"0.2"_fx);
			m_polygonA.SetAsBox(10_fx, "0.2"_fx);
		}

		{
			m_positionB.Set("12.017401"_fx, "0.13678508"_fx);
			m_angleB = -"0.0109265"_fx;
			m_transformB.Set(m_positionB, m_angleB);

			m_polygonB.SetAsBox(2_fx, "0.1"_fx);
		}
	}
	...
	void Step(Settings* settings)
	{
		...
		g_debugDraw.DrawString(5, m_textLine, "distance = %g", (float)output.distance);
		...
		b2Color c1(1_fx, 0_fx, 0_fx);
		g_debugDraw.DrawPoint(x1, 4_fx, c1);

		b2Color c2(1_fx, 1_fx, 0_fx);
		g_debugDraw.DrawPoint(x2, 4_fx, c2);
	}
