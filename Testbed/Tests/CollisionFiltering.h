...
public:
	CollisionFiltering()
	{
		...
		triangleBodyDef.position.Set(-5_fx, 2_fx);
		...
		triangleBodyDef.position.Set(-5_fx, 6_fx);
...

		{
			...
			bd.position.Set(-5_fx, 10_fx);
			b2Body* body = m_world->CreateBody(&bd);

			b2PolygonShape p;
			p.SetAsBox("0.5"_fx, 1_fx);
			body->CreateFixture(&p, 1_fx);

			b2PrismaticJointDef jd;
			jd.bodyA = body2;
			jd.bodyB = body;
			jd.enableLimit = true;
			jd.localAnchorA.Set(0_fx, 4_fx);
			jd.localAnchorB.SetZero();
			jd.localAxisA.Set(0_fx, 1_fx);
			jd.lowerTranslation = -1_fx;
			jd.upperTranslation = 1_fx;
		...
		boxShapeDef.restitution = "0.1"_fx;
		...
		boxBodyDef.position.Set(0_fx, 2_fx);
		...
		boxBodyDef.position.Set(0_fx, 6_fx);
		...
		circleBodyDef.position.Set(5_fx, 2_fx);
		...
		circleBodyDef.position.Set(5_fx, 6_fx);
