...
public:
	Gears()
	{
...

		{
			...
			circle1.m_radius = 1_fx;

			b2PolygonShape box;
			box.SetAsBox("0.5"_fx, 5_fx);

			b2CircleShape circle2;
			circle2.m_radius = 2_fx;
			
			b2BodyDef bd1;
			bd1.type = b2_staticBody;
			bd1.position.Set(10_fx, 9_fx);
			b2Body* body1 = m_world->CreateBody(&bd1);
			body1->CreateFixture(&circle1, 5_fx);

			b2BodyDef bd2;
			bd2.type = b2_dynamicBody;
			bd2.position.Set(10_fx, 8_fx);
			b2Body* body2 = m_world->CreateBody(&bd2);
			body2->CreateFixture(&box, 5_fx);

			b2BodyDef bd3;
			bd3.type = b2_dynamicBody;
			bd3.position.Set(10_fx, 6_fx);
			b2Body* body3 = m_world->CreateBody(&bd3);
			body3->CreateFixture(&circle2, 5_fx);
...

		{
			...
			b2BodyDef bd2;
			bd2.type = b2_dynamicBody;
			bd2.position.Set(0_fx, 12_fx);
			b2Body* body2 = m_world->CreateBody(&bd2);
			body2->CreateFixture(&circle2, 5_fx);
			...
			b2BodyDef bd3;
			bd3.type = b2_dynamicBody;
			bd3.position.Set("2.5"_fx, 12_fx);
			b2Body* body3 = m_world->CreateBody(&bd3);
			body3->CreateFixture(&box, 5_fx);

			b2PrismaticJointDef jd3;
			jd3.Initialize(ground, body3, bd3.position, b2Vec2(0_fx, 1_fx));
			jd3.lowerTranslation = -5_fx;
			jd3.upperTranslation = 5_fx;
			...
			jd5.joint1 = m_joint2;
			jd5.joint2 = m_joint3;
			jd5.ratio = -1_fx / circle2.m_radius;
